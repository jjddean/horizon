...
const App = () => {c
  ...
  const newsCardsData = [
    ...
    {
      type: 'sponsored',
      image: 'https://placehold.co/400x250/FFD700/000000?text=LV+Ring', // Placeholder for the Louis Vuitton ring
    ...
    {
      type: 'article',
      image: 'https://placehold.co/400x250/B22222/FFFFFF?text=Stock+Market', // Placeholder for stock market crash image
    ...
    },
    {
      ...
      time: 'Sponsored', // Assuming this is also sponsored or a commercial link
      likes: 0,
      comments: 0,
      shares: 0,
    },
  ...
  // Sample data for the new section of 6 media cards (2 on top, 4 under)
  ...
  return (
    // Apply scaling to the outermost div of the App component
    <div className="min-h-screen bg-gray-100 font-sans text-gray-800"
         style={{ transform: 'scale(0.35)', transformOrigin: 'top center', width: '285.7%', height: '285.7%' }}> {/* Adjusted overall page scaling */}
      ...
      <div className="relative h-64 md:h-96 bg-cover bg-center"
        ...
        {/* Optional: Overlay for text or branding on the header image */}
      ...
      <div className="container mx-auto px-4 md:px-6 py-6">
            ...
            <div key={i} className="relative rounded-lg shadow-md overflow-hidden border border-gray-200">
              {card.image && (
                <img
                  src={card.image}
                  alt={card.headline}
                  className="w-full h-64 object-cover" // Ensures consistent height for overlay effect
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4"> {/* Base grid for 4 columns */}
            {/* First 2 cards: span 2 columns each to appear "long" */}
            {newMediaCardsData.slice(0, 2).map((card, i) => (
              <div key={i} className="relative rounded-lg shadow-md overflow-hidden border border-gray-200 col-span-1 md:col-span-2"> {/* Span 2 columns */}
                {card.image && (
                  <img
                    src={card.image}
                    alt={card.headline}
                    className="w-full h-64 object-cover" // Consistent height
            ...
            {/* Remaining 4 cards: standard 1-column width */}
            {newMediaCardsData.slice(2, 6).map((card, i) => (
              <div key={i + 2} className="relative rounded-lg shadow-md overflow-hidden border border-gray-200 col-span-1"> {/* Standard 1 column */}
                {card.image && (
                  <img
                    src={card.image}
                    alt={card.headline}
